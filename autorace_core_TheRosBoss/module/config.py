...
WHITE_MODE_CONSTANT = 170 # Для режима белой линии, фиксированный сдвиг от перспективы "несуществующей" желтой линии
YELLOW_MODE_CONSTANT = 615 # Для режима желтой линии, фиксированный сдвиг от перспективы "несуществующей" белой линии
LINE_HISTORY_SIZE = 5 # сколько последних данных хранить о линии в случае ее потери
